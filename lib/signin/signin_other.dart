  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Container(
          child: const Text(
              'Test other providers authentication. (We do not provide an API'
              ' to obtain the token for below providers. Please use a '
              'third party service to obtain token for below providers.)'),
